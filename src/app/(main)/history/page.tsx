        ...
        try {
            ...
            if (savedHistory) {
                try {
                    ...
                    const isValidData = history.every(item => 
                        item && 
                    ...
                    setError("We couldn't load your assessment history due to corrupted data. You may need to start a new assessment.");
                    localStorage.removeItem('mentalHealthAssessments');
                }
            }
        } catch (e) {
            console.error("Error accessing localStorage:", e);
            setError("We couldn't access your assessment history. This may be due to private browsing mode or browser settings.");
        } finally {
            setLoading(false);
        }
    }, []);
        ...
        <div className="flex min-h-screen flex-col items-center bg-background py-8">
            <div className="container mx-auto px-4">
                <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-foreground">Your Mental Health Assessment History</h1>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-7">
                    {/* Assessment list */}
                    <div className="md:col-span-2 overflow-y-auto max-h-[70vh] rounded-lg bg-card p-4 shadow-md">
                                ...
                                >
                                    ...
                                    {checkForCrisisContent(assessment) && (
                                        <div className="absolute top-1 right-1">
                                            <span className="text-red-500" title="This assessment contains concerning content">
                    ...
                    <div className="md:col-span-5 overflow-y-auto max-h-[70vh] rounded-lg bg-card p-6 shadow-md">
                        {selectedAssessment ? (
                            <motion.div
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                            ...
                            >
                                ...
                                <div className="mb-6">
                                    <h3 className="mb-2 text-lg font-semibold text-foreground">Professional Assessment</h3>
            ...
            <Dialog open={showDataOptions} onOpenChange={setShowDataOptions}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Your mental health assessment data is stored locally on your device.
                        ...
                        <div className="rounded-lg border p-3">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Your data is stored locally on your device and is not sent to our servers.
                                        This means your mental health information stays private, but also that
                    ...
                    <DialogFooter>
                        <Button 
                            onClick={() => setShowDataOptions(false)}
                        >
                            Close
                        </Button>
                    </DialogFooter>
            ...
            {/* Export notification */}
            {showExportNotice && (
                <div className="fixed bottom-4 right-4 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-100 px-4 py-2 rounded-md shadow-md flex items-center gap-2">
