...
const MENTAL_HEALTH_KEYWORDS = [
  "depression", "anxiety", "suicide", "suicidal", "self-harm", "cutting", "hurt myself",
  "mental health", "mental illness", "therapy", "therapist", "counseling", "counselor",  
  "psychiatric", "psychiatrist", "psychologist", "disorder", "diagnosis", "medication",
  "bipolar", "schizophrenia", "trauma", "ptsd", "ocd", "eating disorder", "anorexia", 
  "bulimia", "addiction", "substance abuse", "crisis", "panic", "mood", "adhd",
  "burnout", "grief", "stress", "insomnia"
];
...
export async function POST(req: NextRequest) {
  try {
    ...
    if (containsHarmfulContent) {
      return NextResponse.json(
        { 
          generatedText: "I cannot provide information on harmful or dangerous topics. " +
    ...
    const crisisTerms = ["suicide", "kill myself", "want to die", "end my life", "harm myself", "hurt myself"];
    ...
    try {
      ...
      if (containsMentalHealthTerms && !generatedText.includes("not a substitute for professional")) {
      ...
      return NextResponse.json(
        { 
          generatedText: "I'm sorry, I couldn't generate a response at this time. Please try again later.",
          error: errorMessage
        },
        { status: 500 }
      );
